export const data = {
  ...
  part2: [
    ...
    {
      topic: "Topic: Quy trình vào Conference hall",
      questions: [
    ...
    {
      topic: "Topic: Instructions for new students",
      questions: [
    ...
    {
      topic: "Topic: Quy trình vào animal hospital",
      questions: [
    ...
    {
      topic: "Topic: A famous football player: Zinedine Zidane is a famous player from France, he was born in 1972.",
      questions: [
    ...
    {
      topic: "Topic: Enter the conference hall",
      questions: [
    ...
    {
      topic: "Topic: Diễn viên nổi tiếng Jay Mist",
      questions: [
    ...
    {
      topic: "Topic: Buying a new house",
      questions: [
    ...
    {
      topic: "Topic: hand in assignment",
      questions: [
    ...
    {
      topic: "Topic: Quá trình dùng máy in printer",
      questions: [
    ...
    {
      topic: "Topic: A scientist’s life - Albert Einstein",
      questions: [
    ...
    {
      topic: "Topic: Quy trình nộp bài papers work",
      questions: [
    ...
    {
      topic: "Topic: Participate in a race.",
      questions: [
    ...
    {
      topic: "Topic: Quy trình nộp report",
      questions: [
    ...
    {
      topic: "Topic: Using public cycle",
      questions: [
    ...
    {
      topic: "Topic: Quy trình trồng khoai",
      questions: [
    ...
    {
      topic: "Topic: Natural history center",
      questions: [
